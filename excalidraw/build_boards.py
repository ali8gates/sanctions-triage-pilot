...
def render(name: str, width: int, height: int, body_svg: str, title: str | None = None) -> None:
    ...
    svg_path = f"/home/user/workspace/aml/repo/excalidraw/{name}.svg"
    png_path = f"/home/user/workspace/aml/repo/excalidraw/{name}.png"
...
def make_scene(elements: list[dict]) -> dict:
    return {
        "type": "excalidraw",
        "version": 2,
        "source": "https://github.com/ali8gates/sanctions-triage-pilot",
        "elements": elements,
        "appState": {
            "gridSize": 20,
...
def write_scene(name: str, elements: list[dict]) -> None:
    ...
    path = f"/home/user/workspace/aml/repo/excalidraw/{name}.excalidraw"
...
if __name__ == "__main__":
    ...
    from board_buy_vs_build import build_buy_vs_build_board
    from board_pilot_outcomes import build_pilot_board
